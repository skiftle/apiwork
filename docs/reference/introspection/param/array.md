...
[Param::Base](/reference/introspection/param/base), `nil` — the element type for homogeneous arrays
...
Hash{Symbol =&gt; [Param::Base](/reference/introspection/param/base)} — nested field definitions for array-of-objects
