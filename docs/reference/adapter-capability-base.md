...
|------|------|-------------|
| `klass` | `Class, nil` | a [Builder::API::Base](adapter-builder-api-base) subclass |
...
- [Builder::API::Base](adapter-builder-api-base)
...
Used for configuration options, translation keys, and [Adapter::Base.skip_capability](adapter-base#skip-capability).
...
| Name | Type | Description |
|------|------|-------------|
| `klass` | `Class, nil` | a [Builder::Contract::Base](adapter-builder-contract-base) subclass |
...
- [Builder::Contract::Base](adapter-builder-contract-base)
...
| Name | Type | Description |
|------|------|-------------|
| `klass` | `Class, nil` | an [Operation::Base](adapter-capability-operation-base) subclass |
...
- [Operation::Base](adapter-capability-operation-base)
