...
This is the base format. The [adapter](../adapters/) uses it internally and transforms it for HTTP responses (adding root keys, pagination, key formatting).
...
- [Representation::Base reference](../../../reference/apiwork/representation/base.md) — `serialize` and `deserialize` methods
