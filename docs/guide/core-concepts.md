...
[API definitions](./api-definitions/) describe the surface of your API.
...
[Contracts](./contracts/) define the boundary itself.
...
[Representations](./representations/) connect contracts to your domain models.
...
[Adapters](./adapters/) define the conventions of your API.
...
[Introspection](./introspection/) makes the boundary self-describing.
