...
For integration test patterns, see `integration-tests.md`.

---

## Which Methods to Unit Test

Given a class, there is exactly **one** way to write its test. Follow every rule. No variation. No judgment calls.
...
11. Test data from the registry in `testing.md` (no invented values)
