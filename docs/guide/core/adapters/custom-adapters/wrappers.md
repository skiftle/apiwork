...
Member wrappers inherit from [`Adapter::Wrapper::Member::Base`](/reference/apiwork/adapter/wrapper/member/base):
...
Collection wrappers inherit from [`Adapter::Wrapper::Collection::Base`](/reference/apiwork/adapter/wrapper/collection/base):
...
Error wrappers inherit from [`Adapter::Wrapper::Error::Base`](/reference/apiwork/adapter/wrapper/error/base):
...
- [Wrapper::Member::Base reference](/reference/apiwork/adapter/wrapper/member/base)
- [Wrapper::Collection::Base reference](/reference/apiwork/adapter/wrapper/collection/base)
- [Wrapper::Error::Base reference](/reference/apiwork/adapter/wrapper/error/base)
