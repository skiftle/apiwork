...
Types define the shape of data in contracts.

They describe data shapes, constraints, and meaning. These definitions say what data is allowed at the API boundary — and how it's interpreted.

Types are defined in Ruby. They describe both the wire format and the runtime rules for coercion and validation.
...
Objects define shape, unions define alternatives, and enums constrain values.
...
Those concerns belong to the [Adapter](../adapters/).
