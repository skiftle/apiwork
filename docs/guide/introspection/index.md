...
Introspection exposes API structure as Ruby objects you can query — resources, actions, types, and params.
...
Each introspection object has type-checking methods and navigation accessors.
...
Adapters derive types from representations at runtime. Introspection makes these generated shapes visible.
