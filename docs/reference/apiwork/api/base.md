...
Created via [API.define](/reference/apiwork/introspection/api/#define). Configure resources, types, enums,
...
Custom adapters must be registered via [Adapter.register](/reference/apiwork/adapter/#register) and referenced by their `adapter_name`.
...
[Adapter::Base](/reference/apiwork/adapter/base), `void` — the adapter instance when called without block

**Yields** [Configuration](/reference/apiwork/configuration/)

**See also**

- [Adapter.register](/reference/apiwork/adapter/#register)
...
[GitHub](https://github.com/skiftle/apiwork/blob/main/lib/apiwork/api/base.rb#L505)
...
**Yields** [Resource](/reference/apiwork/api/resource)
...
[GitHub](https://github.com/skiftle/apiwork/blob/main/lib/apiwork/api/base.rb#L110)
...
**Yields** [API::Object](/reference/apiwork/api/object)
...
[Info](/reference/apiwork/api/info/), `nil`

**Yields** [Info](/reference/apiwork/api/info/)
...
[GitHub](https://github.com/skiftle/apiwork/blob/main/lib/apiwork/api/base.rb#L86)
...
**Yields** [API::Union](/reference/apiwork/api/union)
...
[GitHub](https://github.com/skiftle/apiwork/blob/main/lib/apiwork/api/base.rb#L533)
