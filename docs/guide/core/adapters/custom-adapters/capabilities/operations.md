...
Operations run at request time to process data. They filter, sort, paginate, or otherwise transform the data before serialization. Operations inherit from [`Adapter::Capability::Operation::Base`](/reference/apiwork/adapter/capability/operation/base).
...
For complex shapes, create a separate class inheriting from [`Adapter::Capability::Operation::MetadataShape`](/reference/apiwork/adapter/capability/operation/metadata-shape):
...
- [Capability::Operation::Base reference](/reference/apiwork/adapter/capability/operation/base)
- [Capability::Operation::MetadataShape reference](/reference/apiwork/adapter/capability/operation/metadata-shape)
