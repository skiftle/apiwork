...
[Info::Contact](/reference/apiwork/api/info/contact), `nil`

**See also**

- [Info::Contact](/reference/apiwork/api/info/contact)
...
[Info::License](/reference/apiwork/api/info/license), `nil`

**See also**

- [Info::License](/reference/apiwork/api/info/license)
...
Array&lt;[Info::Server](/reference/apiwork/api/info/server)&gt;

**See also**

- [Info::Server](/reference/apiwork/api/info/server)
