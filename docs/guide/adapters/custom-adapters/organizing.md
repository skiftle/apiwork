...
The adapter is registered in an initializer:
...
The adapter is referenced by name in [API definitions](../../api-definitions/configuration.md#adapter-configuration):
...
- [Adapter Configuration](../../api-definitions/configuration.md#adapter-configuration)
