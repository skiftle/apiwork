...
The built-in adapter maps Rails validation errors to [domain issues](./guide/core/errors/domain-issues.md). The `detail` field in each issue is translatable.
...
See [Domain Issues](./guide/core/errors/domain-issues.md) for the complete list of codes.
