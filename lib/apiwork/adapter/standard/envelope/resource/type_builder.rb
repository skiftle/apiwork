        ...
        class Resource
          class TypeBuilder
                ...
                if association_resource&.schema_class
                  ...
                  if alias_name
                    ...
                    if association_contract_class&.schema?
                      ...
                      sub_builder = self.class.new(association_registrar, association_resource.schema_class, nil)
            ...
            def build_nested_payload_union
              ...
              id_type = TypeMapper.map(model_class.type_for_attribute(model_class.primary_key).type)
              ...
              build_sti_union(union_type_name: union_type_name) do |variant_schema_class, tag, _visited|
                ...
                unless registrar.api_registrar.type?(variant_type_name)
                  registrar.api_registrar.object(variant_type_name) do
                    ...
                    variant = union.variants[tag.to_sym]
