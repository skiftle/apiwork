...
ActiveRecord::Schema[8.1].define(version: 2026_02_19_000005) do
  ...
  create_table "calm_bear_receipts", id: :string, force: :cascade do |t|
  ...
  create_table "proud_horse_invoices", id: :string, force: :cascade do |t|
  ...
  create_table "quick_otter_invoices", id: :string, force: :cascade do |t|
    t.decimal "amount", precision: 10, scale: 2
  ...
  create_table "silent_deer_payments", id: :string, force: :cascade do |t|
    t.decimal "amount", precision: 10, scale: 2, null: false
    t.datetime "created_at", null: false
  ...
  create_table "warm_robin_customers", id: :string, force: :cascade do |t|
    t.datetime "created_at", null: false
    t.string "email", null: false
    t.string "name", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "warm_robin_invoices", id: :string, force: :cascade do |t|
    t.datetime "created_at", null: false
    ...
    t.decimal "total", precision: 10, scale: 2
    t.datetime "updated_at", null: false
    t.index ["customer_id"], name: "index_warm_robin_invoices_on_customer_id"
  end

  create_table "warm_robin_items", id: :string, force: :cascade do |t|
    t.datetime "created_at", null: false
    ...
    t.datetime "updated_at", null: false
    t.index ["invoice_id"], name: "index_warm_robin_items_on_invoice_id"
  end
  ...
  add_foreign_key "warm_robin_invoices", "warm_robin_customers", column: "customer_id"
  add_foreign_key "warm_robin_items", "warm_robin_invoices", column: "invoice_id"
end
