...
RSpec.describe 'Security and edge case validation' do
  ...
  describe 'large array handling' do
    let(:definition) do
      Apiwork::Contract::ParamDefinition.new(type: :input, contract_class: contract_class).tap do |d|
  ...
  describe 'special character handling' do
    ...
    it 'handles string with max_length constraint' do
      constrained_def = Apiwork::Contract::ParamDefinition.new(type: :input, contract_class: contract_class).tap do |d|
  ...
  describe 'error accumulation' do
    it 'reports multiple validation errors' do
      multi_def = Apiwork::Contract::ParamDefinition.new(type: :input, contract_class: contract_class).tap do |d|
