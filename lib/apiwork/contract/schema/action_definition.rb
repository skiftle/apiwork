    ...
    module Schema
      ...
      module ActionDefinition
        ...
        def merged_output_definition
          # For CRUD actions (index, show, create, update), output_definition is already
          # fully auto-generated by auto_generate_output_if_needed with the new structure
          # (ok, resource/resources, meta, errors). No merging needed.
          return output_definition if output_definition && crud_action?
