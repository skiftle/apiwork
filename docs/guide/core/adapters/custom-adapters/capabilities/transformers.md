...
Request transformers inherit from [`Adapter::Capability::Transformer::Request::Base`](/reference/apiwork/adapter/capability/transformer/request/base):
...
Override to implement transformation logic. Use `request.transform` to modify the request data:
...
Response transformers inherit from [`Adapter::Capability::Transformer::Response::Base`](/reference/apiwork/adapter/capability/transformer/response/base):
...
- [Transformer::Request::Base reference](/reference/apiwork/adapter/capability/transformer/request/base)
- [Transformer::Response::Base reference](/reference/apiwork/adapter/capability/transformer/response/base)
