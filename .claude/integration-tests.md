...
Rules for writing integration tests. Integration tests verify cross-domain behavior: full HTTP pipelines, DSL definitions with introspection, and export generation.

For shared test rules, see `testing.md`.
For unit test patterns, see `unit-tests.md`.
...
7. Test data from the registry in `testing.md` (no invented values)
