...
| [`include`](./include.md)     | Symbol          | `:optional` | `:always` or `:optional`                 |
| [`writable`](./writable.md)    | `bool` / `hash` | `false`     | Allow nested attributes                  |
| [`filterable`](./filtering-sorting.md)  | `bool`          | `false`     | Enable filtering by association          |
| [`sortable`](./filtering-sorting.md)    | `bool`          | `false`     | Enable sorting by association            |
| [`nullable`](./include.md#nullable-vs-optional)    | `bool`          | auto        | Allow null (auto-detected from DB)       |
| [`polymorphic`](./polymorphic.md) | Hash            | `nil`       | Polymorphic type mapping                 |
...
- [Include](./include.md) - Control when associations are loaded
- [Writable](./writable.md) - Nested attribute handling
- [Filtering & Sorting](./filtering-sorting.md) - Query by associations
- [Polymorphic](./polymorphic.md) - Polymorphic associations
