...
These sit alongside the existing `app/controllers/` and `app/models/`. Contracts and representations inherit from these application-level base classes, just like controllers inherit from `ApplicationController`.
