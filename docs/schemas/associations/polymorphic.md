...
Apiwork infers the discriminator column from Rails (e.g., `commentable_type`). See [Inference](../inference.md) for details.
...
- [STI](../sti.md) - Single Table Inheritance (related pattern)
