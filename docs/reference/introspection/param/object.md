...
`Boolean` — true if this is an object param
...
`Boolean` — true if this is a partial object (all fields optional)
...
Hash{Symbol =&gt; [Param::Base](/reference/introspection/param/base)} — nested field definitions
