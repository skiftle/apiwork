...
- [API::Base reference](../../../reference/apiwork/api/base.md) — API-level `object`, `union`, and `enum`
- [Contract::Base reference](../../../reference/apiwork/contract/base.md) — contract-scoped definitions
