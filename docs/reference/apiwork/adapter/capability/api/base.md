...
- [API::Base#enum](/reference/apiwork/api/base#enum)
...
- [API::Base#object](/reference/apiwork/api/base#object)
...
- [API::Base#type?](/reference/apiwork/api/base#type?)
...
- [API::Base#union](/reference/apiwork/api/base#union)
