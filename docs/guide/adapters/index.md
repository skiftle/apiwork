...
4. **Serialize** — Convert records to response data
...
- [Standard Adapter](./standard-adapter/) — the built-in REST adapter
- [Custom Adapters](./custom-adapters/) — build a custom adapter for JSON:API, HAL, or any format
