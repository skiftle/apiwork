...
Exports describe your API in formats understood by external tools. They are derived from [introspection](../introspection/introduction.md) — the same structure that drives runtime validation.
