...
- `include` query parameter (if associations exist)
...
- [Writing](./writing.md) — request body shape for create, update, and delete
- [Actions](../../contracts/actions.md) — defining and overriding action contracts
