...
API builders run once per API at initialization time. They register shared [types](../../../types/) used across all contracts. API builders inherit from [`Adapter::Capability::API::Base`](/reference/apiwork/adapter/capability/api/base).
...
The [`scope`](/reference/apiwork/adapter/capability/api/scope) attribute provides access to aggregated data across all representations:
...
- [Capability::API::Base reference](/reference/apiwork/adapter/capability/api/base)
- [Capability::API::Scope reference](/reference/apiwork/adapter/capability/api/scope)
- [Types](../../../types/)
