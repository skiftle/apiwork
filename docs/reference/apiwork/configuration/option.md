...
in [Adapter::Base](/reference/apiwork/adapter/base) and [Export::Base](/reference/apiwork/export/base) subclasses.
...
**Yields** [Option](/reference/apiwork/configuration/option)
