...
The [adapter](../adapters/) then derives filter types, sort options, request payloads, and response shapes automatically.

## Next Steps

- [Attributes](./attributes/) — declaring scalar fields and their options
