...
class ExampleGenerator
  ...
  def metadata_for(namespace)
    ...
    if File.exist?(yml_path)
      ...
      {
        description: 'Complete example with API, models, representations, contracts, and controllers.',
        order: 999,
  ...
  def legacy_sections(namespace)
    [
      ...
      representations_section(namespace),
  ...
  def representations_section(namespace)
