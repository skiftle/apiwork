...
RSpec.describe 'Includes API', type: :request do
  ...
  describe 'nested includes' do
    ...
    before do
      Api::V1::CommentRepresentation.associations[:post].instance_variable_set(:@include, :optional)
  ...
  describe 'contract validation for always included associations' do
    context 'when association has include: :always' do
      ...
      before do
        Api::V1::CommentRepresentation.associations[:post].instance_variable_set(:@include, :optional)
        Api::V1::PostRepresentation.associations[:comments].instance_variable_set(:@include, :always)
        api_class.reset_contracts!
        api_class.ensure_all_contracts_built!
      end

      after do
        Api::V1::PostRepresentation.associations[:comments].instance_variable_set(:@include, :optional)
        Api::V1::CommentRepresentation.associations[:post].instance_variable_set(:@include, :optional)
        api_class.reset_contracts!
      end
