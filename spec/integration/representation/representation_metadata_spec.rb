...
RSpec.describe 'Representation Metadata', type: :integration do
  describe 'Representation.description' do
    it 'stores description on schema class' do
      expect(Api::V1::ProfileRepresentation.description).to eq('User profile with personal settings')
    end
  ...
  describe 'Representation.example' do
    it 'stores example on schema class' do
      schema_example = Api::V1::ProfileRepresentation.example
  ...
  describe 'Representation.deprecated' do
    ...
    it 'non-deprecated schemas do not have deprecated flag' do
      expect(Api::V1::PostRepresentation.deprecated?).to be(false)
    end
  end
  ...
  describe 'Metadata combination' do
    it 'schema can have description, example, and deprecated together' do
      expect(Api::V1::ProfileRepresentation.description).to eq('User profile with personal settings')
      expect(Api::V1::ProfileRepresentation.example).to be_a(Hash)
      expect(Api::V1::ProfileRepresentation.deprecated?).to be(true)
    end
  end
end
