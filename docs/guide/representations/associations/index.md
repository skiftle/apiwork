...
Apiwork detects the associated representation and nullable from the model. The adapter interprets behavior flags like `filterable` and `writable` at runtime.

## Next Steps

- [Declaration](./declaration.md) — types, auto-detection, options reference, and response shape
