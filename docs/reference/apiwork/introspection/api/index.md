...
Hash{Symbol =&gt; [ErrorCode](/reference/apiwork/introspection/error-code)}
...
[API::Info](/reference/apiwork/api/info/), `nil`
...
Hash{Symbol =&gt; [API::Resource](/reference/apiwork/api/resource)}
