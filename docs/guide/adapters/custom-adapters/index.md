...
The class that converts [errors](../../errors/) to response data. Called for contract errors (validation), domain errors (business logic), and HTTP errors. Also responsible for registering the error type at introspection time.
...
- [Capabilities](./capabilities/) - Self-contained features
