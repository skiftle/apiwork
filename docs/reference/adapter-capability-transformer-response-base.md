...
# Adapter::Capability::Transformer::Response::Base
...
Register transformers in capabilities using [Capability::Base.response_transformer](adapter-capability-base#response-transformer).
