...
RSpec.describe 'has_one Association', type: :request do
  ...
  describe 'has_one association in representation definition' do
    it 'representation has has_one association defined' do
      associations = Api::V1::UserRepresentation.associations
  ...
  describe 'has_one association in introspection' do
    it 'includes has_one in representation introspection' do
