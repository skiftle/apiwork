...
If using the Standard Adapter, pagination strategies are configured with the `adapter` block. See [pagination](../adapters/standard-adapter/pagination.md) for available options.
